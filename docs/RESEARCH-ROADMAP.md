...
| E8 | **Model and data cards** for the drafting seam, regenerated on release. | P11,E1 | P3 | S | **[corroborates ROADMAP v0.3]** ✅ Implemented under `docs/cards/` with a tagged-release drift check. |
